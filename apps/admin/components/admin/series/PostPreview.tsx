    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-gray-200 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="p-8 overflow-y-auto max-h-[calc(90vh-100px)]">
          {category && (
            <div className="mb-4">
              <span className="inline-block px-3 py-1 text-xs rounded-full bg-amber-100 border border-amber-300 text-amber-700">
                {category}
              </span>
            </div>
          )}
          ...
          <div
            className="prose prose-gray max-w-none
                       ...
                       prose-blockquote:border-l-amber-500 prose-blockquote:text-gray-600
                       prose-code:text-amber-600 prose-pre:bg-gray-100
